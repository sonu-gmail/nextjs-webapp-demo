...
const Users = () => {
    ...
    return (
        <>
            {
                (showDeleteModal) ? <DeleteModal userId={userId} onUpdate={updateModalState} /> :''
            }
            <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <div className="px-4 py-6 md:px-6 xl:px-7.5">
                    <h4 className="text-xl font-semibold text-black dark:text-white">
                        ...
                        <tbody>
                            {
                                ...
                                users.map((user, index) => (
                                    <tr key={index}>
                                            ...
                                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                <p className="inline-flex rounded-full bg-opacity-10 px-3 py-1 text-sm font-medium">{user.email}</p>
                                            </td>
                                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                <p className="inline-flex rounded-full bg-opacity-10 px-3 py-1 text-sm font-medium">{user.entry_date}</p>
                                            </td>
                                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div className="flex items-center space-x-3.5">
                                                <button className="hover:text-primary" onClick={() => router.push(`/dashboard/user/${user.id}`)}>
                                                <svg
                                                ...
                                                <button className="hover:text-primary" onClick={() => router.push(`/dashboard/user/edit/${user.id}`)}>
